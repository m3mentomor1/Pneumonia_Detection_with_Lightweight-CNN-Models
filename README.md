...
Throughout the training process, MobileNetV2 demonstrated a steady improvement in both training and validation accuracy, starting with a training accuracy of 69.32% and validation accuracy of 76.45%, and reaching 84.52% and 85.48% respectively by the final epoch. ShuffleNetV2 exhibited a similar pattern, beginning with a training accuracy of 82.58% and validation accuracy of 78.39%, and achieving 88.56% and 87.10% by the end of training. Both models showed effective learning and strong generalization, as evidenced by the close alignment of training and validation accuracies. In contrast, SqueezeNet started with a lower initial training accuracy of 49.06% and validation accuracy of 47.74%. Despite improvements over the epochs, reaching a final training accuracy of 73.78% and validation accuracy of 60.00%, SqueezeNet's validation accuracy lagged behind, indicating potential overfitting issues and challenges in generalizing to unseen data.
<br><br><br>
#### **➜ Confusion Matrix**
